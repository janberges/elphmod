...
def write_flfrc(flfrc, phid, amass, at, tau, atom_order, epsil=None, zeu=None):
    """Write file *flfrc* with force constants as generated by ``q2r.x``."""
...
def q2r(ph, D_irr=None, q_irr=None, nq=None, D_full=None, angle=60,
        ...
        divide_mass=True, divide_ndegen=True, flfrc=None):
    ...
    flfrc : str
        ...
        ``q2r.x``. This is done after `apply_asr_simple` but before `apply_asr`
        and `apply_rsr`.
    """
    if D_full is None:
